                        ...
                        <div class="quick-links text-right">
                            <ul>
                                <li>
                                    ...
                                    <a href="tel:9809793056">+9809790216 </a>
                                </li>
                                <li>
                    ...
                    <div class="logo">
                        <h1 class="hny-logo">
                        	<a class="brand-logo" href="index.php">
                            	<label class="spl-ap">S</label>ophrosyne 360 <span class="fa  fa-hospita-o logo-icon" aria-hidden="true"></span>
                             </a>
                        </h1>                      
                    </div>
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<a href="#link" class="customer-link">
							<h3 class="card-title">Dr Gopika</h3>
						</a>
					</div>
				</div>
				<div class="card">
					...
					<div class="card-body">
						...
						<a href="#link" class="customer-link">
							<h3 class="card-title">Dr Harshitha</h3>
						</a>
					</div>
				</div>
				<div class="card">
					...
					<div class="card-body">
						...
						<a href="#link" class="customer-link">
							<h3 class="card-title">Dr Amisha</h3>
						</a>
					</div>
				</div>
			</div>
					...
					<div class="right-side">
						...
						<div class="sub-columns">
							...
							<div class="sub-one-left">
								<h6>Contact </h6>
								<div class="column2">
									<div class="href1"><span class="fa fa-envelope-o" aria-hidden="true"></span><a href="mailto:healthify@gmail.com">medic@gmail.com</a>
									</div>
									<div class="href2"><span class="fa fa-phone" aria-hidden="true"></span><a href="tel:9809793056">9809793002</a>
									</div>
									<div>
										<p class="contact-para"><span class="fa fa-map-marker" aria-hidden="true"></span>Palakkad, Kerala</p>
									</div>
								</div>
							</div>
							<div class="sub-one-left">
			...
			<div class="below-section">
				<div class="wrapper-full">
					...
					<div class="columns copy-right text-right">
						<p>© 2022 MEDIC CARE. All rights reserved </p>
					</div>
				</div>
				</div>
			</div>
