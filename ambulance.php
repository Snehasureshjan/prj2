	...
	<div class="login-hny">
		<div class="form-content">
			...
			<div class="form-right">
				<div class="overlay">
					<div class="grid-info-form">
						...
						<p>Our expertise in health, medicine and surgery makes us most choosen hospital.</p>
			...
			<div class="form-left">
				...
				<div class="middle">
					<h4>Search Ambulance</h4>
					<p>Welcome! Please enter your place.</p>
				</div>
				<form action="ambulance_view.php" method="post" class="signin-form" autocomplete="off">
