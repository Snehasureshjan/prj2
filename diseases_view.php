                    ...
                    <div class="logo">
                        <h1 class="hny-logo">
                        	<a class="brand-logo" href="index.php">
                        		...
                        		ophrosyne 360<span class="fa  fa-hospital-o logo-icon" aria-hidden="true"></span>
                             </a>
                        </h1>                      
                    </div>
		...
		<div class="grids-layout">
			<div class="wrapper">
				...
				<div class="grid grid-column-2">
                    ...
                    <div class="column">
						<div class="gd-innf">
							<a href="login.php"><img class="img-responsive" src="admin/hospital_photo/<?php echo $row["photo1"];?>" alt="hny" style="width:300px; height:300px;"></a>
							<ul class="admin-list">
        ...
        <div class="grids-layout">
			<div class="wrapper">
				...
				<div class="grid grid-column-2">
                    ...
                    <div class="column">
						<div class="gd-innf">
							<a href="login.php"><img class="img-responsive" src="admin/doctor_photo/<?php echo $row["photo1"];?>" alt="hny" style="width:300px; height:300px;"></a>
							<ul class="admin-list">
