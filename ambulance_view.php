...
<section class="w3l-blog-grids-6">
		...
		<div class="grids-layout">
			<div class="wrapper">
            	<h3 class="hny-title text-center"><span class="sub-title">What They Say?</span>Our Ambulance</h3>
				<div class="grid grid-column-2">
					<?php
					$result = $db->prepare("select * from ambulance where location like'%".$location."%'");
					$result->execute();
                    ...
                    <div class="column">
						<div class="gd-innf">
							<a href="login.php"><img class="img-responsive" src="admin/ambulance_photo/<?php echo $row["photo"];?>" alt="hny"></a>
							<ul class="admin-list">
								<li><a href="login.php"><span class="fa fa-user" aria-hidden="true"></span><?php echo $row["name"];?></a></li>
								<li><a href="login.php"><span class="fa fa-user" aria-hidden="true"></span><?php echo $row["inchaprsn"];?></a></li>
                                <li><a href="login.php"><span class="fa fa-user" aria-hidden="true"></span><?php echo $row["cntn1"];?></a></li>
							</ul>
	
							<h4> <a href="login.php" class="vv-link"><?php echo $row["addr"];?></a></h4>
